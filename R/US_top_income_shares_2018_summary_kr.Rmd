...
text(x = c(1935, 1965, 2018), 
     ...
     cex = 1.5, 
     col = "red")
dev.copy(png, file = "../pics/US_top_income_share_10_2018_kr.png", width = 960, height = 540)
dev.off()
```
...
text(x = c(1935, 1965, 2018), 
     ...
     cex = 1.5, 
     col = "red")
dev.copy(png, file = "../pics/US_top_income_share_1-4-5_2018_kr.png", width = 960, height = 540)
dev.off()
```
...
text(x = c(1935, 1965, 2018), 
     ...
     cex = 1.5, 
     col = "red")
dev.copy(png, file = "../pics/US_top_income_share_0.1-0.4-0.5_2018_kr.png", width = 960, height = 540)
dev.off()
```
...
text(x = c(1935, 1965, 2018), 
     ...
     cex = 1.5, 
     col = "red")
dev.copy(png, file = "../pics/US_top_income_share_0.01-0.09_2018_kr.png", width = 960, height = 540)
dev.off()
```
...
library(tidyverse)
data_10_df <- US_top_income_shares_18[c("Year", "P90_100")]
data_10 <- US_top_income_shares_18[c("Year", "P99_100", "P95_99", "P90_95")]
data_10_tbl <- data_10 %>%
  as_tibble %>%
  gather(key = "Percentiles", value = "Share", -Year) %>%
  mutate(Percentiles = factor(Percentiles, levels = c("P99_100", "P95_99", "P90_95")))
data_1 <- US_top_income_shares_18[c("Year", "P99.9_100", "P99.5_99.9", "P99_99.5")]
data_1_tbl <- data_1 %>%
  as_tibble %>%
  gather(key = "Percentiles", value = "Share", -Year) %>%
  mutate(Percentiles = factor(Percentiles, levels = c("P99.9_100", "P99.5_99.9", "P99_99.5")))
data_01 <- US_top_income_shares_18[c("Year", "P99.99_100", "P99.9_99.99")]
data_01_tbl <- data_01 %>%
  as_tibble %>%
  gather(key = "Percentiles", value = "Share", -Year) %>%
  mutate(Percentiles = factor(Percentiles, levels = c("P99.99_100", "P99.9_99.99")))
```
...
ggplot(data = data_10_df, 
  ...
  annotate("text", 
           x = c(1927.5, 2007, 2012, 2018), y = c(50.5, 50.5, 51.5, 51.5), 
           label = c(1928, 2007, 2012, 2018)) +
  annotate("text", 
           x = c(1935, 1965, 2018), y = c(48.5, 32, 46.5), 
           label = times_label, 
           colour = "red", 
...
ggsave("../pics/US_top_income_share_10_2018_ggplot_kr.png", width = 12, height = 6.75)
```
...
ggplot(data = data_10_tbl, 
  ...
  theme(legend.text = element_text(family = "KoPubWorldDotum Light", size = 12)) +
  guides(colour ="none") +
...
ggsave("../pics/US_top_income_share_1-4-5_2018_ggplot_kr.png", width = 12, height = 6.75)
```
...
ggsave("../pics/US_top_income_share_0.1-0.4-0.5_2018_ggplot_kr.png", width = 12, height = 6.75)
```
...
ggsave("../pics/US_top_income_share_0.01-0.09_2018_ggplot_kr.png", width = 12, height = 6.75)
```
